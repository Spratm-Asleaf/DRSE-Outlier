...
%% Simulate data
[x, y, real_y, y0, real_F] = GenerateData(sys, x_0, T, coeff_alpha, isTimeVariant);
...
%xhat_tauKF = KF(y,sys.F,sys.G,sys.H,sys.Q,sys.R,V_0,x_0);
%xhat_tauKF = xhat_tauKF';
time_tauKF = toc/T;
...
%xhat_WKF = KF(y,sys.F,sys.G,sys.H,sys.Q,sys.R,V_0,x_0);
time_WKF = toc/T;
